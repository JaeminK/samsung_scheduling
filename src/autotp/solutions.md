...
이 문서는 AutoTP의 5가지 구현 과제에 대한 정답과 상세한 설명을 포함합니다.
...
### Problem 4: Stage Construction
- 각 레이어를 PipelineParallelTransformerLayer로 래핑
- 스테이지 내에서의 위치 정보 설정

이러한 구현을 통해 Tensor Parallelism과 Pipeline Parallelism을 결합한 효율적인 분산 학습 시스템을 구축할 수 있습니다.
